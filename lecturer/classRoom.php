...
$user_details_query2 = mysqli_query($con, "SELECT * FROM lecturer WHERE username='$teacherName'");
...
<div class=Wrapper2>
    ...
    <div class="user_details cloumn">
        ...
        <div class="assignment_box">
            <a href="#" id="postBtn"><i class="fab fa-megaport" style='margin-right: 5px;'></i>Lecture Note</a>
